...
<form method="post" action="">
    ...
    <br>
    <a href="cadastroProfissionais.php">Cadastre-se</a> <br>
    <a href="loginUsuario.php">Logue como Usuario</a>
    <?php
session_start();
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["nome"]) && isset($_POST["senha"])) {
    ...
    $sql = "SELECT * FROM profissional WHERE nome = ? AND senha = ?";
    ...
    if ($result->num_rows == 1) {
        ...
        echo "<p><a href='index.php'>Ir para a página principal</a></p>";
    } else {
        // Login falhou
